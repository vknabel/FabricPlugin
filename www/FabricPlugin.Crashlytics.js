...
var FabricCrashlytics = (function () {
    ...
    _createClass(FabricCrashlytics, [{
        ...
        value: function addLog(message) {
            window.fabricIO.core.execPlugin('addLog', [message]);
        }
    }, {
        key: 'sendCrash',
        ...
        value: function recordError(message, code) {
            window.fabricIO.core.execPlugin('recordError', [message, code]);
        }
    }, {
        key: 'setUserIdentifier',
        value: function setUserIdentifier(userIdentifier) {
            window.fabricIO.core.execPlugin('setUserIdentifier', [userIdentifier]);
        }
    }, {
        key: 'setUserName',
        value: function setUserName(userName) {
            window.fabricIO.core.execPlugin('setUserName', [userName]);
        }
    }, {
        key: 'setUserEmail',
        value: function setUserEmail(userEmail) {
            window.fabricIO.core.execPlugin('setUserEmail', [userEmail]);
        }
    }, {
        key: 'setStringValueForKey',
        value: function setStringValueForKey(value, key) {
            window.fabricIO.core.execPlugin('setStringValueForKey', [value, key]);
        }
    }, {
        key: 'setIntValueForKey',
        value: function setIntValueForKey(value, key) {
            window.fabricIO.core.execPlugin('setIntValueForKey', [value, key]);
        }
    }, {
        key: 'setBoolValueForKey',
        value: function setBoolValueForKey(value, key) {
            window.fabricIO.core.execPlugin('setBoolValueForKey', [value, key]);
        }
    }, {
        key: 'setFloatValueForKey',
        value: function setFloatValueForKey(value, key) {
            window.fabricIO.core.execPlugin('setFloatValueForKey', [value, key]);
        }
    }]);
